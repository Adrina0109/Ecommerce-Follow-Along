                ...
                <ul className="list-disc list-inside">
                  {userData.address.map((SingleAddy, index) => (
                    <div key={index}>
                      ...
                      <li key={SingleAddy._id}>Country: {SingleAddy.country}</li>
                      <li key={SingleAddy._id}>Address 1: {SingleAddy.address1}</li>
                      <li key={SingleAddy._id}>Address 2: {SingleAddy.address2}</li>
                      <li key={SingleAddy._id}>Pin Code: {SingleAddy.zipCode}</li>
                      <br />
                    </div>
                  ))}
                </ul>
